...
import UsersAdd from "../../sections/Exceptions/UsersAdd";
import UsersProducts from "../../sections/Exceptions/UsersTable/UsersProducts";
...
export default function Users() {
  ...
  const fetchTodos = async () => {
    try {
      ...
      setTodos(response.data?.exceptions);

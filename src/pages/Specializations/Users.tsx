...
import UsersAdd from "../../sections/Specializations/UsersAdd";
import UsersProducts from "../../sections/Specializations/UsersTable/UsersProducts";
...
export default function Users() {
  ...
  const fetchTodos = async () => {
    try {
      ...
      setTodos(response.data?.specializations);

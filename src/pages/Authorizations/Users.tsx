...
import UsersAdd from "../../sections/Authorizations/UsersAdd";
import UsersProducts from "../../sections/Authorizations/UsersTable/UsersProducts";
...
export default function Users() {
  ...
  const fetchTodos = async () => {
    try {
      ...
      setTodos(response.data?.authorizations);

...
import NotificationAdd from "../../sections/NotficationSection/NotficationAdd";
import NotificationProducts from "../../sections/NotficationSection/NotficationTable/NotficationProducts";
  ...
  const fetchTodos = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}v1/lawyers/notifications`,
        {
          headers: {
